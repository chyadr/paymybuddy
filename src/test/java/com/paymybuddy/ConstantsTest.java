...
public static final Account accountWithZeroBalance= new Account().id(3l).balance(BigDecimal.valueOf(0));
    ...
    public static final User userWithZeroBalance= new User().id(1l).firstName("FirstName").lastName("LastName").email("Email").password("Password").account(accountWithZeroBalance);
    ...
    public static final Page<Transaction> pageTransactionEmpty= Page.empty();
    ...
    public static final BankAccount bankAccount=new BankAccount().id(5l).user(user).iban("iban").bic("bic");
